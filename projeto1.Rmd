...
```{r fig.cap="Gráfico da estimação da curva para os dados teóricos"}
...
```{r fig.cap="Gráfico dos valores ajustados pelos resíduos do modelo"}
...
funcao_tabela <- function(dados, grupo, variavel){
  titulo <- paste("Tabela de proporção de", variavel,"por grupo")
  return(
    dados %>% 
