...
```{r fig.cap="Gráfico da estimação da curva para os dados teóricos",out.width = "80%", fig.align='center'}
...
```{r fig.cap="Gráfico dos valores ajustados pelos resíduos do modelo",out.width = "80%", fig.align='center'}
...
```{r fig.cap="Concentração preditas com dados teóricos"}
...
```{r, fig.cap="Análise descritiva por grupo para a variável idade"}
variavel <- "idade"
...
```{r, fig.cap="Análise descritiva por grupo para a variável etnia",out.width = "80%", fig.align='center'}
variavel <- "etnia"
...
```{r, fig.cap="Análise descritiva por grupo para a variável escolaridade",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável há quantos anos foi a gestação de interesse",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável peso",out.width = "80%", fig.align='center'}
variavel = "peso"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável IMC",out.width = "80%", fig.align='center'}
variavel = "imc"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável gordura",out.width = "80%", fig.align='center'}
variavel = "gordura"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável pressão sistólica",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável pressão diastólica",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável pressão média",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável cintura",out.width = "80%", fig.align='center'}
variavel = "cintura"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável circunferência do abdômen",out.width = "80%", fig.align='center'}
variavel = "abdomen"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável quadril",out.width = "80%", fig.align='center'}
variavel = "quadril"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável de relação da cintura vs quadril",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável neutrófilos",out.width = "80%", fig.align='center'}
variavel = "neu"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável linfócitos",out.width = "80%", fig.align='center'}
variavel = "lym"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, , fig.cap="Análise descritiva por grupo para a variável NLR",out.width = "80%", fig.align='center'}
variavel = "nlr"
...
```{r, fig.cap="Análise descritiva por grupo para a variável colesterol total",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável HDL",out.width = "80%", fig.align='center'}
variavel = "hdl"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável LDL dosado",out.width = "80%", fig.align='center'}
variavel = "ldl_dosado"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável VLDL",out.width = "80%", fig.align='center'}
variavel = "vldl"
...
```{r, fig.cap="Análise descritiva por grupo para a variável Não-HDL",out.width = "80%", fig.align='center'}
variavel = "nao_hdl"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável triglicérides",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável HbA1c",out.width = "80%", fig.align='center'}
variavel = "hba1c"
...
```{r, fig.cap="Análise descritiva por grupo para a variável creatinina",out.width = "80%", fig.align='center'}
variavel = "hba1c"
df_filtro <- retira_extremos(df1, variavel, 4)
...
```{r, fig.cap="Análise descritiva por grupo para a variável filtração glomerular",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável TGP/ALT",out.width = "80%", fig.align='center'}
variavel = "tgp_alt"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável TGO/AST",out.width = "80%", fig.align='center'}
variavel = "tgo_ast"
graficos(df1, "grupo", variavel)
teste <- realizar_teste(df1, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável ácido úrico",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável CK",out.width = "80%", fig.align='center'}
variavel = "ck"
graficos(df1, "grupo", variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável Gama GT",out.width = "80%", fig.align='center'}
variavel = "gama_gt"
...
```{r, fig.cap="Análise descritiva por grupo para a variável quantos anos passou-se do evento",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável peso do bebê",out.width = "80%", fig.align='center'}
variavel = "peso_bebe"
...
```{r, fig.cap="Análise descritiva por grupo para a variável tipo de parto",out.width = "80%", fig.align='center'}
df2_filtro <- df2 %>% 
...
```{r, fig.cap="Análise descritiva por grupo para a variável prematuro",out.width = "80%", fig.align='center'}
df2_filtro <- df2 %>% 
  filter(prematuro != "<NA>")
...
```{r, fig.cap="Análise descritiva por grupo para a variável PAI-1",out.width = "80%", fig.align='center'}
variavel = "pai1"
...
```{r, fig.cap="Análise descritiva por grupo para a variável trombomodulina",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável ADMA",out.width = "80%", fig.align='center'}
variavel = "adma"
...
```{r, fig.cap="Análise descritiva por grupo para a variável AA-AT1",out.width = "80%", fig.align='center'}
variavel = "aaat1"
graficos(df3, "grupo", variavel)
teste <- realizar_teste(df3, variavel)
...
```{r, fig.cap="Análise descritiva por grupo para a variável sflt1 sem previsões",out.width = "80%", fig.align='center'}
variavel = "sflt1"
...
```{r, fig.cap="Análise descritiva por grupo para a variável Sflt1 com previsões feitas pelo ajuste da curva",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável Sflt1 com previsões feitas pelo método da Luiza",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável dimero",out.width = "80%", fig.align='center'}
variavel = "dimero"
...
```{r, fig.cap="Análise descritiva por grupo para a variável hipertensão",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável anti-hipertensivo",out.width = "80%", fig.align='center'}
variavel = "anti_hiper"
...
```{r, fig.cap="Análise descritiva por grupo para a variável diabetes",out.width = "80%", fig.align='center'}
variavel = "diabetes"
...
```{r, fig.cap="Análise descritiva por grupo para a variável medicamento para diabetes",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável hipercolesterolemia",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável medicamento para hipercolesterolemia",out.width = "80%", fig.align='center'}
...
```{r, fig.cap="Análise descritiva por grupo para a variável fumantes",out.width = "80%", fig.align='center'}
variavel = "tabagista"
