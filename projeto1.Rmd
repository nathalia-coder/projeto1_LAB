...
Optou-se por variar o $\beta$ no estudo (1 - $\beta$ indica o poder do teste). Testes mais poderosos implicam em maior rigor do tamanho amostral, espera-se aumento do tamanho da amostra quando avaliar-se isso.
...
```{r}
allmean = data.frame(grupo=c(rep("2",4)),
                     imc=rep(c(25,30,35,40),1)
                     )
allmean
allmean$pred.prob = predict(modelo2, newdata=allmean, type="response")
allmean
```
